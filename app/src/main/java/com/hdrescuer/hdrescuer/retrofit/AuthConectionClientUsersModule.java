...
public class AuthConectionClientUsersModule {



    private static AuthConectionClientUsersModule instance = null;

    private AuthApiService authApiService;

    private Retrofit retrofit;

    public AuthConectionClientUsersModule() {
    ...
    public static AuthConectionClientUsersModule getInstance(){

        if(instance == null){
            instance = new AuthConectionClientUsersModule();
        }
