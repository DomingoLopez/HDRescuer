...
public class AuthConectionClientSessionsModule {



    private static AuthConectionClientSessionsModule instance = null;

    private AuthApiService authApiService;

    private Retrofit retrofit;

    public AuthConectionClientSessionsModule() {
        ...
        this.retrofit = new Retrofit.Builder()
                            .baseUrl(Constants.DATA_RESCUER_SESSIONS_MODULE_URL)
    ...
    public static AuthConectionClientSessionsModule getInstance(){

        if(instance == null){
            instance = new AuthConectionClientSessionsModule();
        }
